...
export function EmployeeLeaveApplyPanel() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-5 p-4 md:p-6 animate-fade-in">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600/90 via-purple-600/75 to-[#0d0f14] px-5 py-5 text-white shadow-lg ring-1 ring-violet-500/30">
